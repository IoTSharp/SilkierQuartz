...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class ExecutionHistoryStoreServiceCollectionExtensions
    {
            ...
            Action<IServiceProvider, DbContextOptionsBuilder> configureDbContext)
        {
            ...
            services.AddDbContextFactory<Quartz.Plugins.RecentHistory.EFCoreSqlite.ExecutionHistoryDbContext>(configureDbContext);
            services.RemoveAll<IExecutionHistoryStore>();
            services.AddSingleton<IExecutionHistoryStore, Quartz.Plugins.RecentHistory.EFCoreSqlite.EfCoreExecutionHistoryStore>();
            return services;
        }
    }
}
