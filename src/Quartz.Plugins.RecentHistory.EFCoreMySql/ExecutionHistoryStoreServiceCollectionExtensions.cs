...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class ExecutionHistoryStoreServiceCollectionExtensions
    {
            ...
            Action<IServiceProvider, DbContextOptionsBuilder> configureDbContext)
        {
            ...
            services.AddDbContextFactory<Quartz.Plugins.RecentHistory.EFCoreMySql.ExecutionHistoryDbContext>(configureDbContext);
            services.RemoveAll<IExecutionHistoryStore>();
            services.AddSingleton<IExecutionHistoryStore, Quartz.Plugins.RecentHistory.EFCoreMySql.EfCoreExecutionHistoryStore>();
            return services;
        }
    }
}
