...
namespace Quartz.Plugins.RecentHistory.EFCoreNpgsql.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fire_instance_id = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    scheduler_instance_id = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    scheduler_name = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    job_name = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    trigger_name = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    scheduled_fire_time_utc = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    actual_fire_time_utc = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    recovering = table.Column<int>(type: "integer", nullable: false),
                    vetoed = table.Column<int>(type: "integer", nullable: false),
                    finished_time_utc = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
